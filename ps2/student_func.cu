                   ...
                   const float* const filter, const int filterWidth)
{
    ...
    float average = 0.0f;
    for(int filter_r = -half_width; filter_r <= half_width; filter_r++)
    {
                      ...
                      unsigned char* const blueChannel)
{
    ...
    redChannel[index] = pixel.x;
    greenChannel[index] = pixel.y;
    blueChannel[index] = pixel.z;
}
                                ...
                                const float* const h_filter, const size_t filterWidth)
{
    ...
    size_t numBytes = sizeof(float) * filterWidth * filterWidth;
    //TODO:
                        ...
                        const int filterWidth)
{
    ...
    gaussian_blur<<<gridSize, blockSize>>>(
        d_green, d_greenBlurred, 
        numRows, numCols, 
        d_filter, filterWidth);
    gaussian_blur<<<gridSize, blockSize>>>(
        d_blue, d_blueBlurred, 
        numRows, numCols, 
        d_filter, filterWidth);
